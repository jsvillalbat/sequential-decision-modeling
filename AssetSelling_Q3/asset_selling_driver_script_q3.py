...
import pandas as pd
import numpy as np
from asset_selling_model_q3 import AssetSellingModel
from asset_selling_policy_q3 import AssetSellingPolicy
...
if __name__ == "__main__":
    ...
    sheet1 = pd.read_excel("data/asset_selling_policy_parameters_Q3.xlsx", sheet_name="Sheet1")
    params = zip(sheet1['param1'], sheet1['param2'])
    param_list = list(params)
    sheet2 = pd.read_excel("data/asset_selling_policy_parameters_Q3.xlsx", sheet_name="Sheet2")
    sheet3 = pd.read_excel("data/asset_selling_policy_parameters_Q3.xlsx", sheet_name="Sheet3")
    biasdf = pd.read_excel("data/asset_selling_policy_parameters_Q3.xlsx", sheet_name="Sheet4")
